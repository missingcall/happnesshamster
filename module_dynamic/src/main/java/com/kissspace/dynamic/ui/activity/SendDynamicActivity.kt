...
class SendDynamicActivity : BaseActivity(R.layout.dynamic_activity_send) {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mBinding.ivSendVoice.alpha = 0.5f
...
//                }
                ...
                mediaPlayer.setOnPreparedListener {
                    ...
                    timer?.scheduleAtFixedRate(object : TimerTask() {
                        override fun run() {
                             ...
                             mViewModel.playDuration.value = currentProgress
                        }
                    }, 0, updateInterval.toLong())
                }
                mediaPlayer.setOnCompletionListener {
                    timer?.cancel()
                    mViewModel.playDuration.value = 100
                    if (mBinding.ivVoice.drawable is AnimationDrawable) {
        ...
        mBinding.ivSendPicture.safeClick {
            if (mViewModel.showRecordFile.value) {
                ...
                mBinding.ivSendVoice.alpha = 0.5f
                mBinding.ivSendPicture.alpha = 1f
        ...
        mBinding.ivSendVoice.safeClick {
            if (mViewModel.selectImageCount.value != 0) {
                ...
                mBinding.ivSendVoice.alpha = 1f
                mBinding.ivSendPicture.alpha = 0.5f
    ...
    private fun finishSendDynamic() {
        ...
        FlowBus.post(Event.DynamicsHandlerEvent(DynamicsHandlerBean(type = 1)))
        finish()
    }
