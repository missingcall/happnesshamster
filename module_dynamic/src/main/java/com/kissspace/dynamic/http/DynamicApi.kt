...
object DynamicApi {
    ...
    const val API_GET_DYNAMICS_WITH_USER = "/djsoul-user/dynamics/queryThisUserDynamicsList"
    ...
    const val API_DYNAMIC_FOLLOW = "/djsoul-user/userAttention/attentionUser"

    const val API_DYNAMIC_UN_FOLLOW = "/djsoul-user/dynamics/likeOrCancelLiking"
    ...
    const val API_DYNAMIC_DETAIL = "/djsoul-user/dynamics/obtainDynamicDetailsBasedOnDynamicId"
