...
class MineInletView :ConstraintLayout{
    ...
    init {
        ...
        mIcon = findViewById(R.id.iv_type_icon)
    }
    ...
    constructor(context: Context, attributeSet: AttributeSet?) : super(context, attributeSet) {
        withStyledAttributes(attributeSet, R.styleable.MineInletView) {
            ...
            labelIcon = getResourceId(R.styleable.MineInletView_mineInletView_labelIcon,0)
        }
        initView()
    }
    ...
    private fun initView() {
        ...
        mIcon?.visibility = if(labelIcon == 0) GONE else {
            mIcon?.setImageResource(labelIcon)
            VISIBLE
        }
    }
