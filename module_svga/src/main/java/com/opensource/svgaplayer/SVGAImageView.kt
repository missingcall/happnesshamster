...
import com.kissspace.module_svga.R
...
open class SVGAImageView @JvmOverloads constructor(
    ...
    private class AnimatorListener(view: SVGAImageView) : Animator.AnimatorListener { // end of AnimatorListener
    ...
    private class AnimatorUpdateListener(view: SVGAImageView) : ValueAnimator.AnimatorUpdateListener { // end of AnimatorUpdateListener
        private val weakReference = WeakReference<SVGAImageView>(view)
