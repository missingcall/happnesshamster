...
class MusicViewModel : BaseViewModel() {
    ...
    val collectEvent = _collectEvent.asSharedFlow()
     ...
     val collectListEventData = MutableSharedFlow<ResultState<RoomMusicCollectListBean>>()
     val collectListEvent = collectListEventData.asSharedFlow()
    ...
    fun  queryCollectMusicList(page:Int = 1){
        ...
        param["pageNum"] = page
        param["pageSize"] = 20
        request(RoomApi.API_COLLECT_MUSIC_LIST, Method.GET, param, state = collectListEventData)
    }
}