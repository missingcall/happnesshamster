...
import com.kissspace.common.model.config.WxConfig
...
object MMKVProvider : MMKVOwner {
    ...
    var userProfileInfo by mmkvGson<UserProfileBean>()
    ...
    //提现比率
    var withdrawDepositFee by mmkvString(default = "0%")
...
//    var isShowGame by mmkvBool(default = false)
    ...
    //用户等级
    var consumeLevel by mmkvInt(default = 0)

    var gameConfig by mmkvString()

    var wxConfig by mmkvGson<WxConfig>()
