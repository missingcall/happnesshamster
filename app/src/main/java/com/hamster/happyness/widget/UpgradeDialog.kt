...
import com.hamster.happyness.databinding.DialogUpgradeBinding
...
class UpgradeDialog : BaseDialogFragment<DialogUpgradeBinding>(DialogUpgradeBinding::inflate,Gravity.CENTER) {
